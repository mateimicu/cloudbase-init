from cloudbaseinit.plugins.windows import displayidletimeout as dtimeout
...
class DisplayIdleTimeoutConfigPluginTests(unittest.TestCase):
    def setUp(self):
        ...
        self._displayplugin = dtimeout.DisplayIdleTimeoutConfigPlugin()
    ...
    def test_execute(self, mock_set_display):
        expected_logging = [
            ...
            dtimeout.CONF.display_idle_timeout
        ]
        ...
        with self.snatcher:
            ...
            self.assertEqual(result,
                             (dtimeout.base.PLUGIN_EXECUTION_DONE,
                              False))
